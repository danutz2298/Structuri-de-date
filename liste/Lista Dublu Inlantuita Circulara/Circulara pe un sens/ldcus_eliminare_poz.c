// Program ce creeaza o lista dublu inlantuita circulara pe un sens si sterge elemente pozitive din ea
#include <stdio.h>
#include <stdlib.h>
...
int main(){
    ...
    printf("elementele listei dupa stergere celor pozitive sunt:");
