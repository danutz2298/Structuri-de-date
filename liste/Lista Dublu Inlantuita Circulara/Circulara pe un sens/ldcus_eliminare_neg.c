// Program ce creeaza o lista dublu inlantuita circulara pe un sens si sterge elemente negative din ea
#include <stdio.h>
#include <stdlib.h>
...
void sterge_negative(struct node** head){
...
int main(){
    ...
    printf("elementele listei dupa stergere celor negative sunt:");
    sterge_negative(&head);
    afiseaza_ldcus(head);
    printf("\n");
}