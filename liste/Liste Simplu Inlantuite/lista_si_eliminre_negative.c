// Program ce sterge dintr-o lista simpla elementele negative
#include <stdio.h>
#include <stdlib.h>
...
void sterge_negative(struct Node** n){
    struct Node *current_node;
    current_node = *n;

    while(current_node->next != NULL){
        if(current_node->data < 0){
            sterge_nod_li(n, current_node->data);
        }
        current_node = current_node->next;
    }
...
int main(){
    ...
    printf("lista dupa stergerea elementelor negative:");
